<template>
    <div class="flex flex-col min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:justify-end sm:ml-6 w-1/2">
                        ...
                        <!-- Settings Dropdown -->
                        <div class="flex item-center ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                <template #trigger>
                                    <button v-if="$page.props.jetstream.managesProfilePhotos" class="flex items-center text-sm 
                                    border-2 border-transparent rounded-full focus:outline-none 
                                    focus:border-transparent transition duration-150 ease-in-out">
                                        ...
                                        focus:text-gray-700 focus:border-transparent transition
                                        duration-150 ease-in-out" v-else>
                                            <div>
        ...
        <div class="flex flex-wrap pt-16 sm:flex-nowrap">
            <!-- Page sidebar -->
           <side-bar></side-bar>
            <main class="bg-gray-200 shadow rounded my-5 py-6 px-4 w-full sm:w-2/3 sm:mx-2
