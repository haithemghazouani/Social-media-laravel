<template>
    ...
    <div class="flex justify-around items-center bg-gray-100 min-h-screen">
        <div>
            <img :src="'storage/images/chat-welcome.png'" alt="Social Network">
        </div>
        <div class="text-center">
          ...
          <div v-if="canLogin" class="flex justify-center space-x-6 mt-5">
              ...
              <template v-else>
                  ...
                  <inertia-link :href="route('register')" vif="canRegister" class="text-white bg-gray-800 rounded px-3 py-1 hover:bg-gray-500">
                      Register
                  </inertia-link>  
              </template>
         </div> 
